...
2. Once the `TriathlonEvent` instance has been created, create and register participants with the following types and
names:
...
4. Once the event has been performed, if there is a winner print the text "<winner name> wins first place with a total
time of <total time> minutes!". If there is no winner print the text "No one finished the race!".
