...
class ParticipantTests: XCTestCase {
	...
	func testMetersPerMinuteForSwimmingWithSwimmingFavoriteSport() {
		...
		XCTAssertEqual(testParticipant.metersPerMinute(for: .swimming, randomValue: 0.5), 47, "Participant extension metersPerMinute(for:) did not return 45 for Sport.swimming when favoriteSport was Sport.swimming")
	}
	...
	func testMetersPerMinuteForCyclingWithCyclingFavoriteSport() {
		...
		XCTAssertEqual(testParticipant.metersPerMinute(for:.cycling, randomValue: 0.5), 550, "Participant extension metersPerMinute(for:) did not return 525 for Sport.cycling when favoriteSport was Sport.cycling")
	}
	...
	func testMetersPerMinuteForRunningWithRunningFavoriteSport() {
		...
		XCTAssertEqual(testParticipant.metersPerMinute(for:.running, randomValue: 0.5), 172, "Participant extension metersPerMinute(for:) did not return 164 for Sport.running when favoriteSport was Sport.running")
	}
